...
class Member(models.Model):
    ...
    city =  models.CharField(max_length= 255, choices=cities_options, default="NULL")
    member = models.CharField(max_length = 255, choices= member_type, default="NULL")
    ...
    gender = models.CharField(max_length = 1, choices= gender_options, default="NULL")
...
class Connection(models.Model):
    ...
    connection_member_id = models.ForeignKey(Member, on_delete=models.CASCADE , related_name = 'connection_member_id', null = True, blank = True)
    member_id = models.ForeignKey(Member, on_delete=models.CASCADE, related_name = 'member_id' , null = True, blank = True)
...
class Message(models.Model):
    ...
    creator_id = models.ForeignKey(Member, on_delete=models.CASCADE, null = True, blank = True)

class MessageRecipient(models.Model):
    recipient_id = models.ForeignKey(Member, on_delete=models.CASCADE, null = True, blank = True)
